...
python train_4folds_freeze_AWP2.py --config /kaggle/scripts/yaml/EX023.yaml > /kaggle/output/EX023/log.txt
python train_4folds_freeze_AWP2.py --config /kaggle/scripts/yaml/EX024.yaml > /kaggle/output/EX024/log.txt
python train_4folds_freeze_AWP2.py --config /kaggle/scripts/yaml/EX025.yaml > /kaggle/output/EX025/log.txt
