...
# python train_alldata.py --config /kaggle/scripts/yaml/EX013.yaml > /kaggle/output/EX013/log.txt
python train_4folds_freeze.py --config /kaggle/scripts/yaml/EX012.yaml > /kaggle/output/EX012/log.txt
