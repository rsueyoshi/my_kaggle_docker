...
class DebertaV2Do5ForTokenClassification_12hiddenstates(DebertaV2PreTrainedModel):
    def __init__(self, config):
        ...
        self.classifier = nn.Linear(config.hidden_size * n_layers, config.num_labels)
    ...
    def forward(
        ...
        sequence_output = torch.cat(all_hidden_states[-n_layers:], dim=-1)
